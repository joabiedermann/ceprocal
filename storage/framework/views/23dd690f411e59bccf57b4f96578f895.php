                                                    ...
                                                    <td class="d-flex justify-content-center">
                                                        <ul class="action">
                                                            ...
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('teachers.edit')): ?>
                                                                <li class="me-2">
                                                                    <a href="#" class="btn btn-xs btn-outline-primary edit-btn" data-bs-toggle="modal" data-bs-target="#editModal" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Editar" data-url="<?php echo e(route('teachers.edit', $teacher->id)); ?>">
                                                                        <i class="fa fa-eye"></i>
                                                                    </a>
                                                                </li>
                                                            <?php endif; ?>
