    ...
    <section class="section-py-space riho-page-section" id="home">
        <div class="container-fluid fluid-space">
            <div class="title text-center">
                ...
                <div class="row d-flex justify-content-center mt-2">
                    <div class="col-md-2">
                        <form action="<?php echo e(route('verificate_certificate')); ?>" method="post">
                            <?php echo csrf_field(); ?> 
                            <div class="input-group">
...
<?php echo $__env->make('landings.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ceprocal\resources\views/landings/home/index.blade.php ENDPATH**/ ?>