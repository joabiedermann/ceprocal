<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.create')): ?>
    ...
    <?php $__env->startSection('main_content'); ?>
        ...
        <div class="container-fluid">
            <form class="row g-3" action="<?php echo e(route('roles.store')); ?>" method="post" id="store-form">
                <?php echo csrf_field(); ?>
                <div class="row g-2">
...
unset($__errorArgs, $__bag); ?>" id="nombre" name="nombre" value="<?php echo e(old('nombre')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-9 d-flex justify-content-end">
                                        <div class="col-md-2 me-2 text-center">
                                            ...
                                            <input type="text" class="form-control text-center" id="estado" value="Activo" readonly>
                                        </div>
                                        <div class="col-md-2 text-center">
                                            ...
                                            <input type="text" class="form-control text-center" id="cantidad_permisos"
                                                name="cantidad_permisos" value="<?php echo e(old('cantidad_permisos', 0)); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button type="button" class="btn btn-outline-primary" id="seleccionar-todo">Seleccionar todo</button>
                            </div>
                            <div class="card-body">
                                <div class="row">
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('custom/js/roles/create.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/js/sweetalert/sweetalert.min.js')); ?>"></script>
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ceprocal\resources\views/roles/create.blade.php ENDPATH**/ ?>