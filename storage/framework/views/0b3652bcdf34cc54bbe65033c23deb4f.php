<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('forums_certificates.upload')): ?>
    ...
    <?php $__env->startSection('main_content'); ?>
                ...
                <div class="row g-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Descargar Plantilla"
                            href="<?php echo e(asset('storage/importar-excel-foros.xlsx')); ?>" download="importar-excel-foros.xlsx">
        ...
        <div class="container-fluid">
            <form class="row g-3" action="<?php echo e(route('forums_certificates.upload')); ?>" method="post" id="store-form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="row g-2">
                                    <?php if(!session('errores')): ?>
                                        <div class="col-md-12 alert alert-danger" role="alert">
                                            No olvide verificar su archivo antes de subirlo, puede descargar la plantilla haciendo click <a href="<?php echo e(asset('storage/importar-excel-foros.xlsx')); ?>"> AQUÍ</a> para comprobar que el formato sea correcto.
                                        </div>
                                    <?php endif; ?>
                                    <div class="col-md-8">
...
unset($__errorArgs, $__bag); ?>" id="planilla" name="planilla" aria-describedby="planilla" aria-label="Upload" accept=".xls, .xlsx, .csv">
    ...
    <?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('custom/js/forums_certificates/import.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/js/sweetalert/sweetalert.min.js')); ?>"></script>
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ceprocal\resources\views/forums_certificates/import.blade.php ENDPATH**/ ?>