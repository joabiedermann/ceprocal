<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('company.create')): ?>
    ...
    <?php $__env->startSection('main_content'); ?>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Nuevos Parámetros</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <form class="row g-3" action="<?php echo e(route('company.store')); ?>" method="post" id="store-form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row g-2">
...
unset($__errorArgs, $__bag); ?>" id="nombre_fantasia" name="nombre_fantasia" value="<?php echo e(old('nombre_fantasia')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>" id="razon_social" name="razon_social" value="<?php echo e(old('razon_social')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="ruc" name="ruc" value="<?php echo e(old('ruc')); ?>" >
                                        <?php $__errorArgs = ['ruc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="telefono" name="telefono" value="<?php echo e(old('telefono')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="pais" name="pais" value="<?php echo e(old('pais')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="ciudad" name="ciudad" value="<?php echo e(old('ciudad')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="actividad" name="actividad" value="<?php echo e(old('actividad')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="direccion" name="direccion" value="<?php echo e(old('direccion')); ?>" >
...
unset($__errorArgs, $__bag); ?>" id="logo" name="logo" aria-describedby="logo" aria-label="Upload" accept=".jpg, .jpeg, .png">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-center">
                                            <img src="<?php echo e(asset('storage/no-image.png')); ?>" alt="Imagen" id="vista" style="width: 190px; height:190px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('custom/js/companies/create.js')); ?>"></script>
    ...
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ceprocal\resources\views/company/create.blade.php ENDPATH**/ ?>