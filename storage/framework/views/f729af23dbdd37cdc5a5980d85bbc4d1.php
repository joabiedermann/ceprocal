<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.show')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.create')): ?>
                    <div class="row g-2">
                        <div class="col-sm-12 d-flex justify-content-end">
                            <a class="btn btn-outline-success" href="<?php echo e(route('roles.create')); ?>"><i class="fa fa-plus align-middle"></i> &nbsp; Agregar</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr role="row" class="odd">
                                                    <td class="sorting_1"><?php echo e($role->name); ?></td>
                                                    <td class="text-center"><?php echo e($role->users->count()); ?></td>
                                                    <td class="text-center"><?php echo e($role->permissions->count()); ?></td>
                                                    <td class="text-center fw-bold <?php echo e($class); ?>"><?php echo e($status); ?></td>
                                                    <td class="d-flex justify-content-center">
                                                        <ul class="action">
                                                            <li class="me-2">
                                                                <a href="<?php echo e(route('roles.show', $role->id)); ?>" class="btn btn-xs btn-outline-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Visualizar">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                            </li>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.edit')): ?>
                                                                <li class="me-2">
                                                                    <a href="<?php echo e(route('roles.edit', $role->id)); ?>" class="btn btn-xs btn-outline-warning" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Visualizar">
                                                                        <i class="fa fa-pencil"></i>
                                                                    </a>
                                                                </li>
                                                            <?php endif; ?>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.edit_status')): ?>
                                                                <li class="me-2">
                                                                    <a href="#" class="btn btn-xs <?php echo e($icon_class); ?> status-btn" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="<?php echo e($text_icon); ?>" data-url="<?php echo e(route('roles.get_status', $role->id)); ?>">
                                                            ...
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.destroy')): ?>
                                                                <li>
                                                                    <a href="#" class="btn btn-xs btn-outline-danger destroy-btn" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Visualizar" data-url="<?php echo e(route('roles.get_destroy', $role->id)); ?>">
    ...
    <?php $__env->startSection('scripts'); ?>
        <script src="<?php echo e(asset('custom/js/roles/index.js')); ?>"></script>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ceprocal\resources\views/roles/index.blade.php ENDPATH**/ ?>