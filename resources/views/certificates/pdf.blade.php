...
<html lang="sp">
    ...
    <body>
        ...
        <div class="content">
            ...
            <p class="course"> {{ $course->name }} ({{ $course->hours }} H) </p>
            <p class="activity">Actividad organizada por el Centro Paraguayo de Productividad y Calidad - CEPROCAL y la
                <br>
                Unión Industrial Paraguaya - UIP finalizado en fecha {{ Carbon\Carbon::parse($course->end_date)->format('d/m/Y') }}
            </p>
        ...
        <div class="qr">
            <div class="qr_content">
                <img src="data:image/png;base64,' . {{ $qr_content }} . '" alt="qr_content">
            </div>
            <div class="qr_content_text">
                <span>CONTENIDO PROGRAMÁTICO</span>
            </div>
            <div class="qr_verify">
                <img src="data:image/png;base64,' . {{ $qr_verify }} . '" alt="qr_verify">
            </div>
