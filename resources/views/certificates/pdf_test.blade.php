...
<html lang="sp">
    <head>
        ...
        <style>
            @font-face {
                ...
                src: local('Maven Pro'), local('Maven-Pro'), url('{{ storage_path('fonts/MavenProRegular.ttf') }}') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
            @page {
    ...
    <body>
        ...
        <div class="qr">
            ...
            <div class="qr_verify">
                {{-- {!! QrCode::size(130)->generate({{ route('verificate_certificate', ['course' => 24, 'student' => 7, 'hash' => Hash::make('24iGPx7G96ZXdg2PgZd9')]) }}) !!} --}}
            </div>
            <div class="qr_verify_text">
                <span>VERIFICACIÓN DE AUTENTICIDAD</span>
                <br>
                <span>{{ Hash::make('24iGPx7G96ZXdg2PgZd9') }}</span>
            </div>
        </div>
    </body>
</html>