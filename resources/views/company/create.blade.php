@can('company.create')
    ...
    @section('main_content')
        ...
        <div class="container-fluid">
            <form class="row g-3" action="{{ route('company.store') }}" method="post" id="store-form" enctype="multipart/form-data">
                @csrf
                <div class="row g-2">
                            ...
                            <div class="card-body">
                                <div class="row g-2 d-flex justify-content-center">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre_fantasia') is-invalid @enderror" id="nombre_fantasia" name="nombre_fantasia" value="{{ old('nombre_fantasia') }}" autofocus>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('actividad') is-invalid @enderror" id="actividad" name="actividad" value="{{ old('actividad') }}" >
                                        @error('actividad')
                                            <span class="invalid-feedback" role="alert">
                                                {{ $message }}
                                            </span>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="text-center">
                                            <img src="{{asset('storage/no-image.png')}}" alt="Imagen" id="vista" style="width: 190px; height:190px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @endsection
    @section('scripts')
        <script src="{{ asset('custom/js/companies/create.js') }}"></script>
