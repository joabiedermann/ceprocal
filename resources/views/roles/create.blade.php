@can('roles.create')
    ...
    @section('main_content')
        ...
        <div class="container-fluid">
            <form class="row g-3" action="{{ route('roles.store') }}" method="post" id="store-form">
                @csrf
                <div class="row g-2">
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre') }}" autofocus>
                                        @error('nombre')
                                    ...
                                    <div class="col-md-9 d-flex justify-content-end">
                                        ...
                                        <div class="col-md-2 text-center">
                                            ...
                                            <input type="text" class="form-control text-center" id="cantidad_permisos"
                                                name="cantidad_permisos" value="{{ old('cantidad_permisos', 0) }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @endsection
    @section('scripts')
        <script src="{{ asset('custom/js/roles/create.js') }}"></script>
