@can('forums_certificates.upload')
    ...
    @section('main_content')
                ...
                <div class="row g-2">
                    <div class="col-sm-6 d-flex align-items-center">
                        ...
                        <a type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Descargar Plantilla"
                            href="{{ asset('storage/importar-excel-foros.xlsx') }}" download="importar-excel-foros.xlsx">
        ...
        <div class="container-fluid">
            <form class="row g-3" action="{{ route('forums_certificates.upload') }}" method="post" id="store-form" enctype="multipart/form-data">
                @csrf
                                ...
                                <div class="row g-2">
                                    @if (!session('errores'))
                                        <div class="col-md-12 alert alert-danger" role="alert">
                                            No olvide verificar su archivo antes de subirlo, puede descargar la plantilla haciendo click <a href="{{ asset('storage/importar-excel-foros.xlsx') }}"> AQUÍ</a> para comprobar que el formato sea correcto.
                                        </div>
                                    @endif
                                    <div class="col-md-8">
    ...
    @endsection
    @section('scripts')
        <script src="{{ asset('custom/js/forums_certificates/import.js') }}"></script>
