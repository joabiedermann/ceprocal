    ...
    $('.show-btn').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#nombre-show').val(data.teacher.name);
                $('#documento-show').val(data.teacher.document_number);
                $('#telefono-show').val(data.teacher.phone_number);
                $('#email-show').val(data.teacher.email);
                $('#estado-show').val(data.teacher.status_text);
            },
            ...
            success: function (data) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let $url = "teachers/update_status/" + data.teacher.id;
                        update_status($url);
                    }
                });
            },
        ...
        $.ajax({
            ...
            success: function (data) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let $url = "teachers/destroy/" + data.teacher.id;
                        destroy($url);
                    }
                });
            },
